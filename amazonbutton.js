function AmazonAffiliate() {
    ...
    script1['src'] = 'https://requirejs.org/docs/release/2.3.6/comments/require.js'; //as of 11/20/19
    ...
    // For pages that want to do inline require() calls, it is best to nest those inside a require() call for the configuration:
    ...
    var client = amazon.createClient({
		awsId: "AKIAI3WW6Y5EI2PSNIKA",
		awsSecret: "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",
		awsTag: "amerinatiosta-20"
    });
